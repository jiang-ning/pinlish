...
const dict = {
  a: ['a', 'ai', 'an', 'ang', 'ao'],
  b: ['bo', 'ba', 'bai', 'ban', 'bang', 'bao', 'bei', 'ben', 'beng', 'bi', 'bian', 'biao', 'bie', 'bin', 'bing', 'bu'],
  c: [
    'ci',
    'ca',
    'cai',
  ...
  e: ['e', 'ei', 'en', 'eng', 'er'],
  f: ['fo', 'fa', 'fan', 'fang', 'fei', 'fen', 'feng', 'fou', 'fu'],
  g: [
    'ge',
    'ga',
    'gai',
  ...
  y: ['yi', 'ya', 'yan', 'yang', 'yao', 'ye', 'yin', 'ying', 'yo', 'yong', 'you', 'yu', 'yuan', 'yue', 'yun'],
  z: [
    'zi',
    'za',
    'zai',
